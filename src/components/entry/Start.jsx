...
const Start = (props) => {
    ...
    return (
        <div>
            ...
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$2.75</Button>
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$5</Button>
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$10</Button>
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$20</Button>
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$50</Button>
            <Button buttonStyle="btn-secondary__active" buttonSize="btn-donations">$100</Button>
