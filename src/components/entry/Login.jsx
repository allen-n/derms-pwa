...
const Login = props => {
    ...
    return (
        <Form onSubmit={handleSubmit} onChange={handleChange}>
            ...
            <h2>Sign in</h2>
            <h4 className="margin-bottom-thirty">New to the community? <Link to="/signup">Sign up</Link></h4>
            ...
            <Button variant="primary" type="submit" disabled={isDisabled}><strong>Submit</strong></Button>
        </Form>
    );
